...
Master's student in Big Data & Data Science with a background in Mathematics.
I build end-to-end machine learning pipelines across NLP, Computer Vision, and predictive modeling.
...
- M.Sc. Big Data & Data Science — Horizon University, Sousse
- B.Sc. Mathematics — Higher School of Science and Technology, Sousse
- Strong mathematical foundation applied to deep learning and statistical modeling
- Experience building and deploying ML systems from data preprocessing to production APIs
- Competitive chess player — strategic thinking and pattern recognition transfer directly to ML
...
- DeepLearning.AI & Stanford — Machine Learning Specialization (Supervised Learning, Deep Learning, Unsupervised Learning, Reinforcement Learning)
- IBM — Data Science Professional Certificate (Python, SQL, ML, Data Visualization)
- NVIDIA — Deep Learning, Real-Time Video AI, Accelerated Data Science, Transformer-Based NLP

---

## Connect

- LinkedIn: [linkedin.com/in/muhammedattia](https://linkedin.com/in/muhammedattia)
- Email: attiamuhammed1@gmail.com
